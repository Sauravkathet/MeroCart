# MeroCart - A simple eCommerce website

 MeroCart is an open-source **Next.js eCommerce frontend** project.  
...
1. Clone the repo
    ...
    ```bash
    git clone https://github.com/GreatStackDev/ MeroCart.git
    cd MeroCart
    ```
...
Thanks to everyone who contributes to ** MeroCart**!